...
;;
;; python mode XXX removed since not included in homeshick
;;
...
;;
;; clang and autocomplete need emacs 24.3 or later as well as llvm-config
;;

;; (add-to-list 'load-path "~/.x86_64-apple-darwin14.0.0/lgc.com/yasnippet")
;; (setq yas-snippet-dirs
;;       '("~/.x86_64-apple-darwin14.0.0/lgc.com/yasnippet/personal/snippets"            ;; personal snippets
;;         "~/.x86_64-apple-darwin14.0.0/lgc.com/yasnippet/snippets"    ;; the default collection
;;         ))
;; (require 'yasnippet)
;; (yas-global-mode 1)

;; (add-to-list 'load-path "~/.x86_64-apple-darwin14.0.0/lgc.com/auto-complete-1.3.1")
;; (add-to-list 'load-path "~/.x86_64-apple-darwin14.0.0/lgc.com/emacs-clang-complete-async") 
