...
;; Maintainer:    Not me!  I've seen the light and it is NEXTSTEP :-)
;; Created:       May 1994
;; Version:       1.11
;; Last Modified: 1995/07/11 22:00:14
...
;; of hacks that did some nice indentation of resource lines, but they
;; were not organized in any way.  This mode was my attempt to congeal
;; this mess into a proper major mode.  I release it now, not because
;; it will change your life, but because I don't plan to do anything
;; more with it.
;;
;; I have since been enlightened and no longer have to cavort with
;; mere mortal X hackers anymore.  I like my brain cells, so now I use
;; NEXTSTEP where all is glory.  Or would you say I traded one vice
;; for another?  Hmm...  Anyway, if you are still down in the trenches
;; and would like to inherit this file, let me know.  I don't intend
;; to do any work on it any more... unless I lose my place in
;; paradise.  I promise to be good, Steve.  :-) :-)
;;
;; So, I'd like to give this orphan a proper home.  Mommy?  Daddy?

;; LCD Archive Entry:
;; xrdb-mode|Barry A. Warsaw|bwarsaw@cnri.reston.va.us
;; |mode for editing X resource database files
;; |1995/07/11 22:00:14|1.11|
...
(if xrdb-mode-map
  ...
  (let ((ekey (char-to-string xrdb-separator-char)))
    ...
    (define-key xrdb-mode-map "\C-c\C-b" 'xrdb-indent-buffer)
