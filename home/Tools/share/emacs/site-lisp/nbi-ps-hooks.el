...
;; Is it XEmacs?
(defconst nbi-xemacs-p
  (string-match "\\(Lucid\\|XEmacs\\)" emacs-version))

(if nbi-xemacs-p
    (progn
    (defvar nbi-ps-prsc [print] "*Key for spooling buffer with faces")
    (defvar nbi-ps-s-prsc [(shift print)] "*Key for spooling region with faces")
    (defvar nbi-ps-c-prsc [(control print)] "*Key for despooling ps-print output"))
  (progn
    (defvar nbi-ps-prsc [print] "*Key for spooling buffer with faces")
