...
;; 18-August-1995|2.07|~/packages/filladapt.el| 
...
(defun fill-region-as-paragraph (beg end &optional justify nosqueeze)
  (interactive "*r\nP")
  (if (and filladapt-mode (not filladapt-inside-filladapt))
	...
	(filladapt-funcall 'fill-region-as-paragraph beg end justify nosqueeze)
